"""
Q4 Revenue Snapshot - Sales Forecasting Dashboard Module
=========================================================
Reads from Demand_planning_DB_aistudio Google Sheet and displays gap-to-goal analysis 
with interactive visualizations. Includes lead time logic for Q4/Q1 fulfillment 
determination and detailed order drill-downs.

Data Sources (Demand_planning_DB_aistudio):
- deals: HubSpot pipeline data (was "All Reps All Pipelines")
- _NS_Invoices_Data: NetSuite invoices (was "NS Invoices")
- _NS_SalesOrders_Data: NetSuite sales orders (was "NS Sales Orders")
- Dashboard Info: Rep quotas and orders
- Q4 Push: Planning status

Author: Xander @ Calyx Containers
Version: 2.0.0 (Adapted for S&OP Dashboard integration)
"""
...
# Page configuration - REMOVED (handled by main App 1().py)
# st.set_page_config() is called in the main app
...
def load_all_data():
    ...
    # UPDATED: Changed from "NS Invoices" to "_NS_Invoices_Data" for new Demand_planning_DB_aistudio sheet
    ...
    # UPDATED: Changed from "NS Sales Orders" to "_NS_SalesOrders_Data" for new Demand_planning_DB_aistudio sheet
...
# Main render function - called by App 1().py
def render_q4_revenue_snapshot():
    """
    Main render function for Q4 Revenue Snapshot section.
    Called from the main App 1().py navigation.
    """
